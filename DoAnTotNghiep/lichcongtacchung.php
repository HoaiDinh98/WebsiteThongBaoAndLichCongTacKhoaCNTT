...
//     $startDate = date("Y-m-d", strtotime( $currentYear . "-W" . $selectedWeek . "-1")); 
//     $endDate = date("Y-m-d", strtotime( $currentYear . "-W" . $selectedWeek . "-7"));
//     $dataDay = Lichcongtac::TimkiemLichTheoTuan($pdo, $startDate,$endDate);
// }
if (isset($_POST['search'])) {
            ...
            <div class="d-flex gap-2 justify-content-center">
                        <!-- <form name="from-search" method = 'POST' class="d-flex gap-2 justify-content-center">
                            ...
                            for ($week = 1; $week <= $weekCount; $week++) {
                                ...
                                $selected = ($week == $weekNumber) ? "selected" : ""; // Kiểm tra nếu tuần hiện tại thì đặt selected
                               // echo '<option value="' . $week. '">' . 'Tuần thứ ' . $week . ' (Từ ' . $startDate  . ' đến ' . $endDate .')'. '</option>';
                    ...
                    <h5> LỊCH CÔNG TÁC CHUNG </h5>
                            <div style="border: 1px solid black; overflow: auto;border-bottom: none; height: 800px;" >
                            <div >
                                ...
                                foreach($dataDay as  $lichcongtac1 ):?> 
                                    ...
                                    <?php $data = Lichcongtac::getDay($pdo, $lichcongtac1['NgayTao']); ?>
                                        <?php foreach($data as  $item ):?>  
                                            ...
                                            <?php $idnguoidung = $_SESSION['gianvien_id'] ?>
