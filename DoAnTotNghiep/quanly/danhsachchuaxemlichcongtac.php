...
$limit = $perPage;
$data = Lichcongtac::getPageAllNguoiDungChuaXem2($pdo,$IDNhomNguoiNhan,$IDThongBao, $limit, $offset);


$totalThongbao = Lichcongtac::DemNguoiDungChuaXem2($pdo,$IDNhomNguoiNhan,$IDThongBao);
...
<div class="col-10">
            ...
            <div class=" text-left" style="margin-top:10vh;">
                <div class="page-toolbar" style="display: flex;">
                    <h1 class="page-title pull-left">Danh sách chưa xem lịch công tác</h1>
                </div>
                    ...
                    <div class=" " style="border: 1px solid black;margin-left: 5px;height: 700px;">
                            ...
                            <div >
                                ...
                                <?php 
                                        ...
                                        <?php $tennguoidung = $_SESSION['quanly'] ?>
                                        <?php if ($tennguoidung == $thongbao['HoTen']):?>
                                            <tr> 
                                               <?php $i++;?>
                                                <td><?php echo $i; ?></td>                            
                                                <td style="color: red;"><?=$thongbao['HoTen'] ?></td>   
