...
$limit = $perPage;
$data = Thongbao::getPageAllNguoiDungChuaXem($pdo,$IDThongBao, $limit, $offset);


$totalThongbao = Thongbao::DemNguoiDungChuaXem($pdo,$IDThongBao);
...
<div class="col-10">
            ...
            <div class=" text-left" style="margin-top:10vh;">
                <div class="page-toolbar" style="display: flex;">
                    <h1 class="page-title pull-left">Danh Sách chưa xem thông báo</h1>
                </div>
