...
<?php   
                            ...
                            $IDNguoiTao= $_SESSION['gianvien_id'];
                            $db = new Database();
                            $pdo = $db->getConnect();
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            <li class="nav-item">
                                <a class="nav-link" href="hethong.php">Trang chủ</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="thongbao.php">Thông báo</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="lichcongtacchung.php">Lịch công tác</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link " href="about.php">Hộp thư</a>
                            </li>
                        </ul>
